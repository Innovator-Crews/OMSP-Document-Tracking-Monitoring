  ...
  getSidebarLinks(role) {
    ...
    const links = {
      sysadmin: [
        ...
        { label: 'Financial Assistance', icon: 'file-text', href: `${root}pages/fa-list.html`, id: 'nav-fa-list' },
        { label: 'Personal Assistance', icon: 'clipboard-list', href: `${root}pages/pa-list.html`, id: 'nav-pa-list' },
        { label: 'Incoming Letters', icon: 'inbox', href: `${root}pages/incoming-list.html`, id: 'nav-incoming-list' },
      ...
      board_member: [
        ...
        { label: 'Financial Assistance', icon: 'file-text', href: `${root}pages/fa-list.html`, id: 'nav-fa-list' },
        { label: 'Personal Assistance', icon: 'clipboard-list', href: `${root}pages/pa-list.html`, id: 'nav-pa-list' },
        { type: 'divider', label: 'My Budget & Term' },
        { label: 'Financial Assistance', icon: 'wallet', href: `${root}boardmember/my-fa-budget.html`, id: 'nav-fa-budget' },
        { label: 'Personal Assistance', icon: 'credit-card', href: `${root}boardmember/my-pa-budget.html`, id: 'nav-pa-budget' },
        { label: 'Term / Archive', icon: 'archive', href: `${root}pages/term-management.html`, id: 'nav-term' },
      ...
      secretary: [
        ...
        { label: 'Personal Assistance', icon: 'clipboard-list', href: `${root}pages/pa-list.html`, id: 'nav-pa-list' },
        { type: 'divider', label: 'Incoming Letters' },
        { label: 'New Incoming Letter', icon: 'mail', href: `${root}pages/incoming-new.html`, id: 'nav-incoming-new' },
        { label: 'Incoming Letters', icon: 'inbox', href: `${root}pages/incoming-list.html`, id: 'nav-incoming-list' },
